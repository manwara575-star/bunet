...
public enum PlaybackProvider { BunnyStream = 0, SecureWebRtc = 1, SecureMseEncrypted = 2, DesktopOnly = 3 }

public enum ProtectedMediaStatus { None = 0, SourceUploaded = 1, Packaging = 2, Ready = 3, Failed = 4 }
